...
class grid {
    ...
    void x_shift_left( unsigned int const shift ) {
        ...
        if ( gc.x.upper >= shift ) {
            ...
            auto err = block::set_shmem_size( x_shift_left_kernel<T>, shm_size );
    ...
    void kernel3_x( S const a, S const b, S const c ) {
        ...
        if (( gc.x.lower > 0) && (gc.x.upper > 0)) {
            ...
            auto err = block::set_shmem_size( kernel3_x_kernel<T,S>, shm_size );
    ...
    void kernel3_y( S const a, S const b, S const c ) {
        ...
        if (( gc.y.lower > 0) && (gc.y.upper > 0)) {
            ...
            auto err = block::set_shmem_size( kernel3_y_kernel<T,S>, shm_size );
