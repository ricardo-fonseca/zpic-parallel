...
void Species::move( vec3grid<float3> * J )
{
    ...
    auto err = block::set_shmem_size( kernel::move_deposit, shm_size );
...
void Species::move( vec3grid<float3> * J, const int2 shift )
{
    ...
    auto err = block::set_shmem_size( kernel::move_deposit_shift, shm_size );
...
void Species::push( vec3grid<float3> * const E, vec3grid<float3> * const B )
{
    ...
    switch( push_type ) {
    case( species :: euler ):
        err = block::set_shmem_size( kernel::push <species::euler>, shm_size );
        ...
        break;
    case( species :: boris ):
        err = block::set_shmem_size( kernel::push <species::boris>, shm_size );
...
void Species::deposit_charge( grid<float> &charge ) const {
    ...
    auto err = block::set_shmem_size( kernel::deposit_charge, shm_size );
