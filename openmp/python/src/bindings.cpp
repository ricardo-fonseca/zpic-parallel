    ...
    nb::class_<Species>(m, "Species")
        ...
        .def("gather",
            [](Species &self, part::quant quant) {
                ...
                // Allocate an owning buffer on the heap
                float *data = new float[n];

                // Fill it from the C++ side
                self.gather(quant, data);

                // Capsule: gives NumPy ownership of the buffer.
                // When the ndarray is GC'd, this deleter runs and frees the memory.
        ...
        .def("get_charge",
            [](Species &self) {
                ...
                // Fill it (grid::gather writes a contiguous, row-major-ish layout)
                charge.gather(data);
            ...
            "Deposit and return the charge density as a new 2-D NumPy array.\n"
        ...
        .def("get_phasespace",
            ...
            { 
                ...
                self.dep_phasespace( data, quant, to_float2(range), size);
            ...
            "quant"_a, "range"_a, "size"_a,
            "Deposit and return the requested phasespace density as a new 1-D NumPy array.\n\n"
            "Parameters\n"
            "----------\n"
            "quant : phasespace.quant\n"
            "    Quantity to bin along the axis.\n"
        ...
        .def("get_phasespace",
            ...
            { 
                ...
                float *data = new float[size0 * size1];
                
                self.dep_phasespace( data, 
                    quant0, to_float2(range0), size0,
                    quant1, to_float2(range1), size1
                );
            ...
            "quant0"_a, "range0"_a, "size0"_a,
            "quant1"_a, "range1"_a, "size1"_a,
            "Deposit and return the requested phasespace density as a new 2-D NumPy array.\n\n"
            "Parameters\n"
            "----------\n"
            "quant0, quant1 : phasespace.quant\n"
            "    Quantities to bin along each axis.\n"
