...
namespace Density {
    ...
    class Profile {
        ...
        virtual void inject( Particles & part, uint2 const ppc, float2 const dx, float2 const ref, bounds_2d<unsigned int> range ) const = 0;
    
        virtual void np_inject( Particles & part, uint2 const ppc, float2 const dx, float2 const ref, bounds_2d<unsigned int> range, int * np ) const = 0;
    ...
    class None : public Profile {
        ...
        void inject( Particles & part, uint2 const ppc, float2 const dx, float2 const ref, bounds_2d<unsigned int> range ) const override {
            // no injection
        };
        void np_inject( Particles & part, uint2 const ppc, float2 const dx, float2 const ref, bounds_2d<unsigned int> range, int * np ) const override {
            // no injection
            part.zero_np();
        };
    };
