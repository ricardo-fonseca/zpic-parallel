...
class Pulse {
     ...
     */
    virtual int launch( cyl3grid<ops::complex<float>>& E, cyl3grid<ops::complex<float>>& B, float2 box ) = 0;
    ...
    virtual int add( EMF & emf ) {
        ...
        cyl3grid<ops::complex<float>> tmp_E( E1.global_ntiles, E1.nx, E1.gc, E1.part );
        cyl3grid<ops::complex<float>> tmp_B( B1.global_ntiles, B1.nx, B1.gc, B1.part );
...
class PlaneWave : public Pulse {
    ...
    int launch( cyl3grid<ops::complex<float>>& E, cyl3grid<ops::complex<float>>& B, float2 box );
