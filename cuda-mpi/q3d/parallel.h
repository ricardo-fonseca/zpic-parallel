...
template<> inline MPI_Datatype data_type<ops::complex<float >>(void) { return MPI_C_FLOAT_COMPLEX ; };
template<> inline MPI_Datatype data_type<ops::complex<double >>(void) { return MPI_C_DOUBLE_COMPLEX ; };
...
namespace type {
    ...
    extern MPI_Datatype cyl_cfloat3;
}
...
template<> inline MPI_Datatype data_type<cyl_float3>(void) { return mpi::type::float3; };
template<> inline MPI_Datatype data_type<cyl_double3>(void) { return mpi::type::double3; };

template<> inline MPI_Datatype data_type<cyl_cfloat3>(void) { return mpi::type::cyl_cfloat3; };
...
static inline int init( int *argc, char ***argv ) {
    ...
    if ( ierr == MPI_SUCCESS ) {
        ...
        MPI_Type_contiguous( 3, MPI_C_FLOAT_COMPLEX, &mpi::type::cyl_cfloat3 );
        MPI_Type_commit( &mpi::type::cyl_cfloat3 );
...
static inline int finalize( void ) {
    ...
    MPI_Type_free( &mpi::type::cyl_cfloat3 );
